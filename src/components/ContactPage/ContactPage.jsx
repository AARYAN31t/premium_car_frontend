...
const ContactPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    window.open(`https://wa.me/+917304183378?text=${whatsappMessage}`, '_blank');
          ...
          <div className={styles.infoCard}>
            ...
            <div className="relative z-10 space-y-5">
              ...
              <div className={styles.infoItemContainer}>
                {[
                  { icon: FaWhatsapp, label: 'WhatsApp', value: '+91 7304183378', color: 'bg-green-900/30' },
                  { icon: FaEnvelope, label: 'Email', value: 'contact@aaryanthorat31@gmail.com', color: 'bg-orange-900/30' },
